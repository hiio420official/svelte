  ...
  signal.deps === null && (active_reaction === null || untracking || (active_reaction.f & DERIVED) !== 0)) {
    ...
    if (parent !== null) {
      if ((parent.f & DERIVED) !== 0) {
        ...
        if (!((_a = parent_derived.children) == null ? void 0 : _a.includes(derived2))) {
          (parent_derived.children ?? (parent_derived.children = [])).push(derived2);
        }
      } else {
        var parent_effect = (
          /** @type {Effect} */
        ...
        if (!((_b = parent_effect.deriveds) == null ? void 0 : _b.includes(derived2))) {
          (parent_effect.deriveds ?? (parent_effect.deriveds = [])).push(derived2);
        }
      }
    }
  }
...
//# sourceMappingURL=chunk-KA55G7ZS.js.map
